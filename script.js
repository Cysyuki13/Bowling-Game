        ...
        function createMatch() {
            ...
            const hostRef = matchRef.child('host');
            matchRef.set({
                host: { connected: true, joinedAt: firebase.database.ServerValue.TIMESTAMP },
                guest: null,
                scores: { p1: [], p2: [] },
                ballUpdate: null,
                events: {},
        ...
        function recordRoundScore(scoreValue) {
            ...
            // Mark that at least one score has been recorded in this game
        ...
        function throwBall(speed, sideSpeed = 0) {
            ...
            const ballMass = (targetPinCount === 100) ? 680 : 500;
        ...
        function checkPins() {
            ...
            function showResultMenu() {
                ...
                // Disable button initially in case of non-strike results
                // (Strike results will manage their own enable/disable in their timeout)
                if (fallen !== totalPinsInPlay) {
                    btn.disabled = false;
                    btn.style.opacity = '1';
